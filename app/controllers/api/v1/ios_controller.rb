module Api
    module V1
        class IosController < BaseController
            ...
            def android_update
                render :status=>200, :json=>{:success=>"1", :message=>"Success", :url=>"android_update", :version_code=>"4", :must_update=>"false"}
            end
            ...
            def get_one_program
                ...
                if program.nil?
                    ...
                    render :status=>200, :json=>{:success=>"1", :message=>"Success", :url=>"get_one_program", :program_id => program.id.to_s,:program_name => program.name,:program_duration => program.duration.to_s,:program_overview => program.overview, :program_participants => program.participants}
            end
            ...
            def tips_and_tricks
                ...
                donts = ['Dismiss students from class, as that goes against INJAZ’s educational philosophy.','Talk about anything controversial as this can instigate unnecessary arguments, thus dividing the students and inhibiting cooperation. Avoid discussing matters such as religion, politics, football club teams (i.e. Ahly vs. Zamalek).']
